...
namespace mbfwAPI.Controllers
{
    ...
    public class CitiesController : ControllerBase
    {
        ...
        public CitiesController(Mbfwcontext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<City>> PostCity(City city)
        {
            ...
            return CreatedAtAction("GetCity", new { id = city.Ccode }, city);
        }
        ...
        {
            return _context.Cities.Any(e => e.Ccode == id);
        }
    }
}
